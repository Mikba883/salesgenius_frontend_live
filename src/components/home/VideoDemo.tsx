    ...
    <section className="overflow-hidden py-17.5 lg:py-22.5 xl:py-27.5">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        <div className="relative w-full max-w-[900px] mx-auto">
          {/* Mockup Frame - positioned absolutely to overlay */}
          ...
          {/* GIF/Video content - positioned behind the frame */}
          <div className="absolute inset-0 z-0 flex items-center justify-center pt-[8%] px-[3%]">
            <img 
